...
const Links = () => {
    return (
        <section className="w-full flex flex-row items-center justify-end">
            <ClickableIcon title='Instagram' tooltipPlacement='top' href='https://instagram.com/agustyofr' linkStyles='mr-[7.5px] z-10'>
                <InstagramIconBlack/>
            </ClickableIcon>
            <ClickableIcon title='Twitter' tooltipPlacement='top' href='https://twitter.com/agstnyfr' linkStyles='mx-[7.5px] z-10'>
                <TwitterIconBlack/>
            </ClickableIcon>
            <ClickableIcon title='LinkedIn' tooltipPlacement='top' href='https://www.linkedin.com/in/agustinayofre/' linkStyles='ml-[7.5px] z-10' >
                <LinkedinIconBlack/>
            </ClickableIcon>
        </section>
    )
